...
<VirtualHost *:443>
    ...
    CustomLog ${APACHE_LOG_DIR}/art-reports.linaro.org-access.log combined
    ErrorLog ${APACHE_LOG_DIR}/art-reports.linaro.org-error.log
    ...
    WSGIDaemonProcess art-reports.linaro.org
    WSGIProcessGroup art-reports.linaro.org
    ...
    Alias /static/ /var/www/art-reports.linaro.org/static/
    <Location "/static/">
        Options -Indexes
